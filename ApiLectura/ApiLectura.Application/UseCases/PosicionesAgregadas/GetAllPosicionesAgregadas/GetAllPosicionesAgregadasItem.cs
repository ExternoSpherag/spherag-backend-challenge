...
public record GetAllPosicionesAgregadasItem
{
    public GetAllPosicionesAgregadasItem(DateTimeOffset timeUtc, string symbol, int count, decimal averagePrice, decimal totalQuantity, 
