...
public record GetAlertasPreciosBySymbolItem
{
    public GetAlertasPreciosBySymbolItem(DateTimeOffset createdAt, string symbol, DateTimeOffset previousTime, DateTimeOffset currentTime, decimal previousAverage, decimal currentAverage, 
