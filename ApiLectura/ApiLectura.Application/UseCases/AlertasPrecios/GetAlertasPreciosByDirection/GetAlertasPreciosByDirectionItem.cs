...
public record GetAlertasPreciosByDirectionItem
{
    public GetAlertasPreciosByDirectionItem(DateTimeOffset createdAt, string symbol, DateTimeOffset previousTime, DateTimeOffset currentTime, decimal previousAverage, decimal currentAverage, 
